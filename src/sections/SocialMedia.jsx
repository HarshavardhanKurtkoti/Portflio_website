const SocialMedia = () => {
  return (
    <section className="c-space my-20" id="social-media">
      <p className="section-kicker text-center">Elsewhere</p>
      <h3 className="head-text text-center mt-2">Lets connect</h3>
      <p className="text-white-500 text-center mt-3 mb-10">Find my work, thoughts, and updates across the web.</p>
      <div className="grid lg:grid-cols-5 sm:grid-cols-2 grid-cols-1 gap-5 h-full justify-center">
        <div className="col-span-1 flex flex-col items-center">
          <div className="grid-container text-center">
            <a href="https://www.facebook.com/harsha.kurtkoti" target="_blank" rel="noopener noreferrer">
              <div className="flex justify-center">
                <img src="assets/facebook.png" alt="Facebook" className="w-20 h-20 object-contain" />
              </div>
        ...
        <div className="col-span-1 flex flex-col items-center">
          <div className="grid-container text-center">
            <a href="https://x.com/Harshakurtkoti" target="_blank" rel="noopener noreferrer">
              <div className="flex justify-center">
                <img src="assets/x.png" alt="Twitter" className="w-20 h-20 object-contain" />
              </div>
        ...
        <div className="col-span-1 flex flex-col items-center">
          <div className="grid-container text-center">
            <a href="https://www.instagram.com/__harsha__10__" target="_blank" rel="noopener noreferrer">
              <div className="flex justify-center">
                <img src="assets/instagram.png" alt="Instagram" className="w-20 h-20 object-contain" />
              </div>
        ...
        <div className="col-span-1 flex flex-col items-center">
          <div className="grid-container text-center">
            <a href="https://www.linkedin.com/in/harshavardhan-kurtkoti" target="_blank" rel="noopener noreferrer">
              <div className="flex justify-center">
                <img src="assets/linkedin.png" alt="LinkedIn" className="w-20 h-20 object-contain" />
              </div>
        ...
        <div className="col-span-1 flex flex-col items-center">
          <div className="grid-container text-center">
            <a href="https://github.com/HarshavardhanKurtkoti" target="_blank" rel="noopener noreferrer">
              <div className="flex justify-center">
                <img src="assets/github.png" alt="GitHub" className="w-20 h-20 object-contain" />
              </div>
